...
public class AlerterTransmitter {
	...
	public AlerterTransmitter(AlerterController alerter, String alerterID) {
		...
		this.MqServerIP = IeasConfiguration.IeasAddress.ACTIVEMQ_SERVER_IP;
	...
	public void sendMessage(String message) {
		try {
			Destination queueDestination = this.session.createQueue(IeasConfiguration.IeasAddress.ALERTER_TO_GATEWAY_QUEUE_DESTINATION);
