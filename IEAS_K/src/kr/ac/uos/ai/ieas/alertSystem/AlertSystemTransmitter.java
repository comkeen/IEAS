...
import static kr.ac.uos.ai.ieas.resource.IeasConfiguration.IeasAddress.*;
...
public class AlertSystemTransmitter {
	...
	private void init() {
		try {
			ActiveMQConnectionFactory factory = new ActiveMQConnectionFactory(ACTIVEMQ_SERVER_IP);
